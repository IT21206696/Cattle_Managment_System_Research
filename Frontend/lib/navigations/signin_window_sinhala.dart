...
class SignInSinhala extends StatefulWidget {
  @override
  _SignInSinhalaState createState() => _SignInSinhalaState();
}

class _SignInSinhalaState extends State<SignInSinhala> {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('ඇතුළුවීම සාර්ථකයි!')),
        );
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('අවලංගු පරිශීලක නාමය හෝ මුරපදය')),
        );
      }
    } catch (error) {
      print(error);
          ...
          child: Column(
            ...
            children: [
              ...
              TextField(
                ...
                decoration: _buildInputDecoration('පරිශීලක නාමය'),
              ),
              ...
              TextField(
                ...
                obscureText: true,
                style: TextStyle(color: Colors.white),
                decoration: _buildInputDecoration('මුරපදය'),
              ),
              SizedBox(height: 20.0),
              _isLoading
                  ? Center(
                ...
                child: CustomButton(
                  text: 'උපකරණ පුවරුවට යන්න', // Pass button text
